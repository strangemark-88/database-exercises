...
SELECT pets.pet_name, pets.age, owners.name FROM pets JOIN owners ON pets.owner_id;
...
# TODO: Write a query that will return the the address and the age each pet

SELECT owners.address, pets.age FROM pets JOIN owners ON pets.owner_id;
